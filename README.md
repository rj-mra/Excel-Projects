...
> A curated collection of Excel-based projects covering consumer research, sales analytics, SEO reporting, and business intelligence — built during my MBA specialisation in Market Research & Analytics.
...
These projects span my internship work at **QOH Lifestyle Pvt. Ltd.** (denim apparel brand) and **Launched Global** (data analytics), as well as independent case studies.
...
**Business Problem:** Track competitor denim brands across e-commerce platforms for price changes and customer rating trends.
...
**Business Problem:** Prioritise the best keywords for a denim brand targeting Delhi NCR — balancing search volume, competition, and commercial intent.
...
**Business Problem:** Organise and categorise raw customer review data from multiple platforms for a denim brand.
...
1. Clone or download this repository
   git clone https://github.com/rishi-insights/excel-projects.git
...
**Rishi Gupta** — MBA (Market Research & Analytics)
- 📊 Data Analytics Intern @ Launched Global
- 👖 Marketing Research Intern @ QOH Lifestyle Pvt. Ltd.
- 📍 Dehradun, Uttarakhand, India

🔗 [LinkedIn](https://www.linkedin.com/in/yourlinkedin) · [GitHub Profile](https://github.com/rishi-insights) · [All Repositories](https://github.com/rishi-insights?tab=repositories)
